...
Keep this repo minimal. Prefer crisp, source-grounded skills focused on O2 SDK usage and fast-bridge flows. Avoid adding irrelevant buckets, setup flows, or extra root files.
